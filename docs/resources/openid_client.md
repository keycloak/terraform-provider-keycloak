...
resource "keycloak_openid_client" "openid_client" {
  ...
  client_secret_regenerate_when_changed = time_rotating.rotate.rotation_rfc3339
...
- `client_secret_regenerate_when_changed` - (Optional) Set a value for when changed, regenerates a new client secret
