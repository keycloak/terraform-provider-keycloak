...
- `client_secret_regenerate_when_changed` - (Optional) Arbitrary map of values that, when changed, will trigger rotation of the secret. NOTE! Conflicts with `client_secret` atttribute and can't be used together
