...
prepare-example:
	...
	mkdir -p example/.terraform/plugins/terraform.local/keycloak/keycloak/5.9.0/$(GOOS)_$(GOARCH)
	mkdir -p example/terraform.d/plugins/terraform.local/keycloak/keycloak/5.9.0/$(GOOS)_$(GOARCH)
	cp terraform-provider-keycloak_* example/.terraform/plugins/terraform.local/keycloak/keycloak/5.9.0/$(GOOS)_$(GOARCH)/
	cp terraform-provider-keycloak_* example/terraform.d/plugins/terraform.local/keycloak/keycloak/5.9.0/$(GOOS)_$(GOARCH)/
